...
class ClientController {
    ...
    public ResponseEntity<?> updateClient(@PathVariable("clientId") String clientId,@Valid @RequestBody ClientDTO clientDto) {
        try {
    ...
    public ResponseEntity<?> addAccountToClient(@PathVariable("clientId") String clientId,@Valid @RequestBody AccountDTO accountDto) {
        try {
